...
import com.example.android.notepad.utils.TimeUtils;
...
//END_INCLUDE(paste)
    ...
    private final void updateNote(String text, String title) {
        ...
        // FIXME 保存的时间戳转日期格式保存  modify by zhoupf
        values.put(NotePad.Notes.COLUMN_NAME_MODIFICATION_DATE, TimeUtils.stampToDate(""+System.currentTimeMillis()));
